...
### Troubleshooting
If the DB sidebar fails to load and the console shows `Unexpected end of input` from `db_launcher.js`, reload the extension on `chrome://extensions` to ensure Chrome picks up the full script.
